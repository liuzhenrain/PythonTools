...
def start_get_proxy(a = None,b = None,c = None):
    input_file = a if a != None else ""
    output_file = b if b != None else 'proxies.txt' 
    check_url = c if c != None else IP138
...
if __name__ == '__main__':
    ...
    start_get_proxy(input_file,output_file,check_url)
